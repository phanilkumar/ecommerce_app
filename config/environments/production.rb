...
Rails.application.configure do
  ...
  # Raise delivery errors in production for better debugging
  ...
  # SMTP configuration is handled in config/initializers/mailer.rb
  ...
  # - MAILER_HOST (your production domain)
